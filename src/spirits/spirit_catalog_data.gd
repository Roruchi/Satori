...
func get_entries() -> Array[Dictionary]:
	return [
		...
		"display_name": "Fūjin",
		"riddle_text": "A wind kami circles the heights of Cloud Ridge.",
		...
		"riddle_text": "A fire kami keeps vigil where Ember Shrine glows.",
		...
		"riddle_text": "A mountain kami watches where Sacred Stone gathers.",
