...
| 6 | Phase 5 - itch.io Web Alpha | [031-itch-web-alpha](../specs/031-itch-web-alpha/spec.md) | Drafted | Verified | Local Web build exports, runs, saves across reload, and is packageable for itch.io. Evidence: `specs/031-itch-web-alpha/evidence.md`. |
