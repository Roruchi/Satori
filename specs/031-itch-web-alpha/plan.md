...
Produce and validate a browser-playable Web build suitable for itch.io closed alpha testing.
...
**Testing**: Web export, Playwright smoke, manual reload  
...
**Constraints**: Include runtime CSV/assets; exclude debug/test files  
**Scale/Scope**: itch.io alpha build only

## Constitution Check

- **Spec Traceability**: PASS. Roadmap Phase 5.
- **Godot-Native Fit**: PASS. Uses Godot export preset.
- **Validation Strategy**: PASS. Export + Playwright + manual persistence.
...
**Structure Decision**: Keep Web export in the existing preset and add validation/package docs around it.
